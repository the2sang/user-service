...
import (
  ...
  users "github.com/the2sang/user-service/service"
...
func getUserServiceClient(conn *grpc.ClientConn) users.UserClient {
...
func main() {
  if len(os.Args) != 2 {
    log.Fatal("Must specify a gRPC servere address",)
  }
